  ...
  if (!lead) {
    return (
      <div className="text-center py-20">
        ...
        <button onClick={() => navigate('/admin/leads')} className="mt-4 text-smartlease-teal hover:underline text-sm">
          ← Terug naar leads
        </button>
      </div>
    );
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-4">
        ...
        <div className="space-y-2.5 mb-5">
          {lead.email && (
            <a href={`mailto:${lead.email}`} className="flex items-center gap-3 text-sm text-gray-700 hover:text-smartlease-teal transition">
              <Mail className="h-4 w-4 text-gray-400 flex-shrink-0" /> {lead.email}
            </a>
          )}
          {lead.telefoon && (
            <a href={`tel:${lead.telefoon}`} className="flex items-center gap-3 text-sm text-gray-700 hover:text-smartlease-teal transition">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm pt-2 border-t border-gray-100">
              ...
              <span className="font-bold text-smartlease-teal text-base">{formatPrice(lead.calculator_data.maandbedrag)}/mnd</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-4">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition ${
              notitiesSaved
                ...
                : 'bg-smartlease-teal text-white hover:bg-smartlease-teal/90'
            }`}
          >
            {savingNotities ? (
        ...
        <textarea
          ...
          rows={5}
          className="w-full text-sm text-gray-700 bg-gray-50 rounded-xl p-3 border border-gray-100 focus:outline-none focus:ring-2 focus:ring-smartlease-teal/30 focus:border-smartlease-teal/50 resize-none placeholder-gray-300 transition"
        />
      </div>
