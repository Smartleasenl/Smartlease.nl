...
export default function DealersPage() {
  ...
  const toggleSort = (field: SortField) => {
    if (sortField === field) {
      ...
      setSortField(field);
      setSortDir(field === 'naam' || field === 'plaats' ? 'asc' : 'desc');
    }
  };
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Overzicht van alle dealers uit de voertuig XML feed
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500">Totaal dealers</p>
              <p className="text-2xl font-bold text-gray-900">{dealers.length.toLocaleString('nl-NL')}</p>
            </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-50">
                  {pageData.map((dealer, idx) => (
                    <tr
                      key={`${dealer.naam}-${dealer.postcode}-${idx}`}
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5 text-gray-600">
                          ...
                          <span className="text-gray-400 text-xs">({dealer.postcode})</span>
                        </div>
                      </td>
              ...
              <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    disabled={page === 0}
                    className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 disabled:opacity-30 disabled:hover:bg-transparent transition"
                  >
