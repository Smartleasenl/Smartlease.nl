...
const NAV_ITEMS = [
  ...
  { to: '/financial-lease', label: 'Financial Lease', desc: 'Alles over financial lease', icon: FileText },
...
export function Header() {
  ...
  return (
    <>
      ...
      {/* ─── Main header nav (STICKY — only this part sticks) ─────────────── */}
      ...
      {/* ─── USP Bar (scrolls away) ───────────────────────────────────────── */}
      <div className="bg-smartlease-blue">
        {/* Desktop: statisch gecentreerd */}
      ...
      >
        ...
        {/* Menu panel — positioned below header + USP bar */}
        <div
